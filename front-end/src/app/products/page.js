...
const products = [
    ...
    },
    {
        ...
        self_price: 1499,
        category: "Men's fashions",
        productImage: "https://i.ibb.co/yF8MJCv/Mens-High-Quality-Early-Winter-Premium-Jacket-Reversible-jacket-Sheroon.webp",
    },
    {
        id: 4,
    ...
    return (
        <>
            <section className='py-10 md:py-16 lg:py-28'>
                <div className="syner-container flex gap-5">
                    ...
                    <div className='basis-3/4'>
                        ...
                        <div className='grid gap-5 items-stretch grid-cols-1 md:grid-cols-3 lg:grid-cols-3'>
                            {
                        ...
                        <div className='text-center pt-10'>
                            <Pagination 
                                ...
                                classNames={{
                                    ...
                                    item: "bg-transparent",
                                    cursor:
                                    "syner-primary-bg syner-white font-bold",
                                }}
                            />
                        </div>
                    </div>
