            ...
            <li className="flex md:flex-col py-6 ">
              <div className="flex w-full space-x-2 sm:space-x-4">
                <img
                  ...
                  alt="Polaroid camera"
                />
                <div className="flex flex-col md:justify-between w-full pb-4">
                  <div className="md:flex md:justify-between w-full pb-2 ">
                    ...
                    <div className="h-[25px] mt-2 md:mt-0 md:h-[40px] w-[6rem] md:w-[20%] border border-[#c2c2c2] rounded-lg px-2 md:px-4 flex items-center justify-between gap-5 ">
                      <button
                        type="button"
                        disabled={quantity <= 1}
                    ...
                    <div className="md:text-right md:w-[20%]">
